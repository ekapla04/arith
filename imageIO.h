 ...
 * Memory alloc : Memory allocated for Pnm_ppm, A2Methods_UArray2,
 *                     A2Methods_T, and Pnm_rgb struct
 * C.R.Es : if image is not in correct format or Pnm_ppm, methods,  
 *          or input are null
 */
 ...
 * Returns : Nothing
 * Memory alloc : None
 * C.R.E. :  if rgb elem or destination array are null
 */
 ...
 * Returns : Nothing
 * Memory alloc : Old array with odd dimensions freed, new memory
 ...
 * Returns : Nothing
 * Memory alloc : None
 * C.R.E : if width and height are less than 2
 */
